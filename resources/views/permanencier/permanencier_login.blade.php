			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 pl-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo logo-light d-block mb-2">Service<span>Informatique</span></a>
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('login') }}">
                      ...
                      <a href="{{ route('register') }}" class="d-block mt-3 text-muted">N'avez-vous pas de compte? S'inscrire ici</a>
                    </form>
                  </div>
                </div>
              </div>
